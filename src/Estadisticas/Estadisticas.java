...
public class Estadisticas extends javax.swing.JFrame {
    ...
    public void cargarComboPartido()
    {
        ...
        swCMB=false;
        Procesos sql=new Procesos();
        ResultSet rs=sql.consultarDatos(estSQL, "select id_partido from partido");
    ...
    public int verifPart()
    {
        int temp=0;
         Procesos sql=new Procesos();
        ResultSet rsP=sql.consultarDatos(estSQL, "select count(*) from partido where id_partido='"+idpartido+"'");
        Object valorO;
        try
        {
            rsP.next();
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        ResultSet rs=sql.consultarDatos(estSQL, "select * from estadisticas");
        sql.procesarRB(rs, modelo);
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        String sentenciaSQL="insert into estadisticas values ('"+idPartido+"','"+codJug+"',"+pases+","+goles+","+asist+","+dist+","+ama+","+roj+")";
