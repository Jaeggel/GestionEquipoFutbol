...
public class Jugadores_Partido extends javax.swing.JFrame {
    ...
    public void conexionBD()
    {
        ...
        estSQL=sql.conexion("sa", "sa.1","BD_EQUIPO_FUTBOL","JOEL-PC\\SQLSERVER2");
    }
    public void cerrar()
    {
        try
    ...
    {
        Procesos sql=new Procesos();
        ResultSet rsP=sql.consultarDatos(estSQL, "select nombres_jugador,apellidos_jugador from jugador ");
        Object valorO;
        try
        {
            rsP.next();
            ...
            }else
            {
                try
                {
                    ...
                    ResultSet rs=sql.consultarDatos(estSQL, "select nombres_jugador,apellidos_jugador  from jugador where cod_jugador='"+codJugador+"'");    
                    rs.next();
    ...
    {
        Procesos sql=new Procesos();
        ResultSet rsP=sql.consultarDatos(estSQL, "select posicion from jugador ");
        Object valorO;
        try
        {
            rsP.next();
            ...
            }else
            {
                ...
                {
                    String codJugador=combo.getSelectedItem().toString();
                    ResultSet rs=sql.consultarDatos(estSQL, "select posicion from jugador where cod_jugador='"+codJugador+"'");    
                    rs.next();
    ...
    public void cargarComboJugador(JComboBox combo)
    {
        ...
        swCMB=false;
        Procesos sql=new Procesos();
        ResultSet rs=sql.consultarDatos(estSQL, "select cod_jugador from jugador order by 1 asc");
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        String sentenciaSQL="insert into detalle_partido values ('"+lblId_Partido.getText().trim()+"','"+cmbJ1.getSelectedItem().toString().trim()+"')";
        String sentenciaSQL1="insert into detalle_partido values ('"+lblId_Partido.getText().trim()+"','"+cmbJ2.getSelectedItem().toString().trim()+"')";
        String sentenciaSQL2="insert into detalle_partido values ('"+lblId_Partido.getText().trim()+"','"+cmbJ3.getSelectedItem().toString().trim()+"')";
        String sentenciaSQL3="insert into detalle_partido values ('"+lblId_Partido.getText().trim()+"','"+cmbJ4.getSelectedItem().toString().trim()+"')";
        String sentenciaSQL4="insert into detalle_partido values ('"+lblId_Partido.getText().trim()+"','"+cmbJ5.getSelectedItem().toString().trim()+"')";
        String sentenciaSQL5="insert into detalle_partido values ('"+lblId_Partido.getText().trim()+"','"+cmbJ6.getSelectedItem().toString().trim()+"')";
        String sentenciaSQL6="insert into detalle_partido values ('"+lblId_Partido.getText().trim()+"','"+cmbJ7.getSelectedItem().toString().trim()+"')";
        String sentenciaSQL7="insert into detalle_partido values ('"+lblId_Partido.getText().trim()+"','"+cmbJ8.getSelectedItem().toString().trim()+"')";
        String sentenciaSQL8="insert into detalle_partido values ('"+lblId_Partido.getText().trim()+"','"+cmbJ9.getSelectedItem().toString().trim()+"')";
        String sentenciaSQL9="insert into detalle_partido values ('"+lblId_Partido.getText().trim()+"','"+cmbJ10.getSelectedItem().toString().trim()+"')";
        String sentenciaSQL10="insert into detalle_partido values ('"+lblId_Partido.getText().trim()+"','"+cmbJ11.getSelectedItem().toString().trim()+"')";
