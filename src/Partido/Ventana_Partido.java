...
public class Ventana_Partido extends javax.swing.JFrame {
    ...
    {
        Procesos sql=new Procesos();
        String cadeql="select max(id_partido) from partido";
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
       ...
       //String sentenciaSQL="insert into partido values ('"+id_partido+"','"+fecha+" "+hora+"','"+lugar+"','"+estadio+"','"+arbitro+"','"+resultado+"',"+estado+",'"+rival+"')";
         String sentenciaSQL="UPDATE partido SET  fecha_hora='"+fecha+" "+hora+"',lugar='"+lugar+"',estadio='"+estadio+"',arbitro_designado='"+arbitro+"',resultado='"+resultado+"',estado_partido="+estado+",nombre_equipo_rival='"+rival+"' where id_partido='"+id_partido+"'";                                                                                   
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        ResultSet rs=sql.consultarDatos(estSQL, "select * from partido");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        String sentenciaSQL="DELETE from partido where id_partido='"+txtCodPartido.getText().trim()+"'";
    ...
    private void txtCodPartidoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodPartidoKeyReleased
         if(evt.getKeyChar()==KeyEvent.VK_B)
        {
            ...
            //////////////////////////////////////
            String sentenciaSQL="select * from partido where id_partido='"+txtCodPartido.getText().trim()+"'";
            Procesos obj=new Procesos();
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        String sentenciaSQL="UPDATE partido SET  fecha_hora='"+fecha.trim()+" "+hora.trim()+"',lugar='"+lugar+"',estadio='"+estadio+"',arbitro_designado='"+arbitro+"',resultado='"+resultado+"',estado_partido="+estado+",nombre_equipo_rival='"+rival+"' where id_partido='"+id_partido+"'";
        Procesos obj=new Procesos();
        if(obj.ingresarDatos(estSQL, sentenciaSQL))
        {
    ...
    private void btnJugadoresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJugadoresActionPerformed
        ...
        Procesos sql=new Procesos();
        String sentenciaSQL="insert into partido values ('"+txtCodPartido.getText().trim()+"','01/01/2001','a','a','a','a',0,'a')";
