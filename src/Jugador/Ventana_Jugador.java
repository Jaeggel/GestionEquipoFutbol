...
public class Ventana_Jugador extends javax.swing.JFrame {
    ...
    {
        Procesos sql=new Procesos();
        String cadeql="select max(cod_jugador) from jugador";
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        String sentenciaSQL="insert into jugador values ('"+codJug+"','"+nombres+"','"+apell+"','"+nacion+"','"+duracion+"','"+fecha+"','"+posicion+"','"+numCamiseta+"')";
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        ResultSet rs=sql.consultarDatos(estSQL, "select * from jugador");
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        String posicion=cmbPosicion.getSelectedItem().toString().trim();
        int numCamiseta=Integer.parseInt(cmbNumCamiseta.getSelectedItem().toString().trim());
        String sentenciaSQL="UPDATE jugador SET nombres_jugador='"+nombres+"',apellidos_jugador='"+apell+"',fecha_nac='"+fecha+"',"
    ...
    private void txtCod_JugadorKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCod_JugadorKeyReleased
        if(evt.getKeyChar()==KeyEvent.VK_B)
        {
            ...
            //////////////////////////////////////
            String sentenciaSQL="select * from jugador where cod_jugador='"+txtCod_Jugador.getText().trim()+"'";
            Procesos obj=new Procesos();
            ...
            try{
                rs.next();
                    ...
                    txtFechaNac.setText(String.valueOf(rs.getObject(6)));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        String sentenciaSQL="DELETE from jugador where cod_jugador='"+txtCod_Jugador.getText().trim()+"'";
